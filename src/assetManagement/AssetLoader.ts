...
export class AssetLoader {
  ...
  public async loadAllAssets(): Promise<GameAssets> {
    ...
    this.loadAsset(this.assets.sleepSprite, ASSET_PATHS.sleepSpriteSheet);
  ...
  private calculateTotalAssets(): void {
    // Count: player, slash, water, sleep, home, dirt, seed, barren (handled in its loader), plants, buildings
    const baseCount = 8; // player, slash, water, sleep, home, dirt, seed, barren
